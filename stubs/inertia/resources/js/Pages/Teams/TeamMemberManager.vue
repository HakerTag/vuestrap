<template>
  <div>
    ...
    <jet-dialog-modal id="currentlyManagingRoleModal">
      ...
      <template #footer>
        <jet-secondary-button @click="closeCurrentlyManagingRoleModal">
          Cancel
    ...
    <jet-confirmation-modal id="confirmingLeavingTeamModal">
      ...
      <template #footer>
        <jet-secondary-button @click="$bvModal.hide('confirmingLeavingTeamModal')">
          Cancel
        </jet-secondary-button>
    ...
    <jet-confirmation-modal id="teamMemberBeingRemovedModal">
      ...
      <template #footer>
        <jet-secondary-button @click="closeTeamMemberBeingRemovedModal">
          Cancel
        </jet-secondary-button>
...
export default {
  ...
  methods: {
    ...
    manageRole(teamMember) {
      ...
      this.$bvModal.show('currentlyManagingRoleModal')
    },

    closeCurrentlyManagingRoleModal() {
      this.currentlyManagingRole = false
      this.$bvModal.hide('currentlyManagingRoleModal')
    },
    ...
    updateRole() {
      this.updateRoleForm.put(route('team-members.update', [this.team, this.managingRoleFor]), {
        preserveScroll: true,
        onSuccess: () => {
          this.closeCurrentlyManagingRoleModal()
        },
      })
    },
    ...
    confirmLeavingTeam() {
      ...
      this.$bvModal.show('confirmingLeavingTeamModal')
    },

    closeConfirmingLeavingTeamModal() {
      this.confirmingLeavingTeam = false
      this.$bvModal.hide('confirmingLeavingTeamModal')
    },

    leaveTeam() {
      this.leaveTeamForm.delete(route('team-members.destroy', [this.team, this.$page.props.user], {
        onSuccess: () => {
          this.closeConfirmingLeavingTeamModal()
        }
      }))
    },
    ...
    confirmTeamMemberRemoval(teamMember) {
      ...
      this.$bvModal.show('teamMemberBeingRemovedModal')
    },

    closeTeamMemberBeingRemovedModal() {
      this.teamMemberBeingRemoved = null
      this.$bvModal.hide('teamMemberBeingRemovedModal')
    },
    ...
    removeTeamMember() {
      this.removeTeamMemberForm.delete(route('team-members.destroy', [this.team, this.teamMemberBeingRemoved]), {
        ...
        preserveState: true,
        onSuccess: () => {
          this.closeTeamMemberBeingRemovedModal()
        }
      })
    },
