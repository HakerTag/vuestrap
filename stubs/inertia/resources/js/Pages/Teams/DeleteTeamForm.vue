  ...
  <jet-action-section>
    ...
    <template #content>
      ...
      <jet-confirmation-modal id="confirmingTeamDeletionModal">
        ...
        <template #footer>
          <jet-secondary-button @click="$bvModal.hide('confirmingTeamDeletionModal')">
            Cancel
...
export default {
  ...
  methods: {
    confirmTeamDeletion() {
      this.$bvModal.show('confirmingTeamDeletionModal');
    },

    deleteTeam() {
      this.form.delete(route('teams.destroy', this.team), {
        errorBag: 'deleteTeam',
        onSuccess: () => this.$bvModal.hide('confirmingTeamDeletionModal')
      });
    },
  },
}
