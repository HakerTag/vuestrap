<template>
  <div>
    ...
    <jet-dialog-modal id="displayingTokenModal">
      ...
      <template #footer>
        <jet-secondary-button @click="closeDisplayingTokenModal">
          Close
    ...
    <jet-dialog-modal id="managingPermissionsForModal">
      ...
      <template #footer>
        <jet-secondary-button @click="closeManageApiTokenPermissions">
          Cancel
        </jet-secondary-button>
    ...
    <jet-confirmation-modal id="apiTokenBeingDeletedModal">
      ...
      <template #footer>
        <jet-secondary-button @click="closeConfirmApiTokenDeletion">
          Cancel
        </jet-secondary-button>
    ...
    methods: {
      createApiToken() {
        this.createApiTokenForm.post(route('api-tokens.store'), {
          ...
          onSuccess: () => {
            ...
            this.$bvModal.show('displayingTokenModal')
          }
        })
      },

      closeDisplayingTokenModal() {
        this.displayingToken = false
        this.$bvModal.hide('displayingTokenModal')
      },

      manageApiTokenPermissions(token) {
        this.updateApiTokenForm.permissions = token.abilities
        this.managingPermissionsFor = token
        this.$bvModal.show('managingPermissionsForModal')
      },

      closeManageApiTokenPermissions() {
        this.managingPermissionsFor = null
        this.$bvModal.hide('managingPermissionsForModal')
      },
      ...
      updateApiToken() {
        this.updateApiTokenForm.put(route('api-tokens.update', this.managingPermissionsFor), {
          ...
          preserveState: true,
          onSuccess: () => {
            this.closeManageApiTokenPermissions()
          },
        })
      },
      ...
      confirmApiTokenDeletion(token) {
        ...
        this.$bvModal.show('apiTokenBeingDeletedModal')
      },

      closeConfirmApiTokenDeletion() {
        this.apiTokenBeingDeleted = null
        this.$bvModal.hide('apiTokenBeingDeletedModal')
      },
      ...
      deleteApiToken() {
        this.deleteApiTokenForm.delete(route('api-tokens.destroy', this.apiTokenBeingDeleted), {
          ...
          preserveState: true,
          onSuccess: () => {
            this.closeConfirmApiTokenDeletion()
          },
        })
      },
    }
